...
const OutcomeError = ({ changeInput }: Props): JSX.Element => {
  return (
    <div className="flex flex-col w-full justify-center items-center max-w-[327px] mt-[24px] gap-[24px]">
      ...
      <p className="font-normal text-[16px] text-center leading-[24px] text-[#757575]">
